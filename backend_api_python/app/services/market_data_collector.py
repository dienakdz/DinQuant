...
class MarketDataCollector:
    ...
    def _get_kline(self, market: str, symbol: str, timeframe: str, limit: int = 60) -> Optional[List[Dict[str, Any]]]:
        """
    ...
    def _true_ranges(self, klines: List[Dict[str, Any]]) -> List[float]:
        ...
        for i, k in enumerate(klines):
            ...
            if h <= 0 or low_price <= 0:
                trs.append(0.0)
                continue
            if i == 0:
                trs.append(h - low_price)
            else:
                                ...
                                news_list.append(
                                    {
                                        ...
                                        "sentiment": "negative"
                                        if any(
                                            kw in text for kw in ["war", "conflict", "attack", "战争", "冲突", "袭击"]
                                        )
                                        else "neutral",
