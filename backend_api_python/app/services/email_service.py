...
class EmailService:
    ...
    def verify_code(self, email: str, code: str, code_type: str) -> Tuple[bool, str]:
        ...
        try:
            with get_db_connection() as db:
                ...
                # Mark as used
                cur.execute("UPDATE qd_verification_codes SET used_at = NOW() WHERE id = ?", (code_id,))
                db.commit()
                cur.close()
    ...
    def send_verification_code(self, email: str, code_type: str, ip_address: str = None) -> Tuple[bool, str]:
        ...
        if code_type == "register":
            subject = "DinQuant - Verification Code for Registration"
            action_text = "complete your registration"
        elif code_type == "login":
            subject = "DinQuant - Quick Login Verification Code"
            action_text = "log in to your account"
        elif code_type == "reset_password":
            subject = "DinQuant - Password Reset Verification Code"
            action_text = "reset your password"
        elif code_type == "change_password":
            subject = "DinQuant - Verification Code for Password Change"
            action_text = "change your password"
        elif code_type == "change_email":
            subject = "DinQuant - Verification Code for Email Change"
            action_text = "change your email address"
        else:
            subject = "DinQuant - Verification Code"
            action_text = "complete the verification"

        html_body = f"""
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
            <div style="text-align: center; margin-bottom: 30px;">
                <h1 style="color: #1890ff; margin: 0;">DinQuant</h1>
            ...
            <div style="text-align: center; margin-top: 30px; color: #999; font-size: 12px;">
                <p>&copy; DinQuant. All rights reserved.</p>
            </div>
        </div>
        """
